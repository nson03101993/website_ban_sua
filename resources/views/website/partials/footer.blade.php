                        ...
                        <div class="block_content">
                           ...
                           <div class="about">
                              ...
                              <ul class="list__address">
                                 ...
                                 <li><i class="fa fa-envelope "></i>nson03101993@gmail.com</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     ...
                     <div id="powered" class="powered ">
                        <div class="row">
                           <div class="col-md-6 col-sm-12 col-xs-12">
                              <p class="text-center">&copy; Copyright {{ now()->year }} bản quyền thuộc về Nguyễn Ngọc Sơn.</p>
                              <p class="text-center"><a href="#">Powered by Google</a></p>
                           </div>
                           <div class="col-md-6 col-sm-12 col-xs-12">
